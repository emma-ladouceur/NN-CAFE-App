        ...
        column(12,
               ...
               fixedRow(column(12, align = "center",
                               ...
                               fixedRow(
                                   column(12,
                                          br(),
                                          h2("Figure S2: Species Richness & Biomass"),
                                          br(),
                                          "Relationship between the mean plot level species richness and biomass (raw data) from the starting point of each site before NPK treatment (year 0 - open circle) and in the most recent measurement in time (arrow). Green arrow represents the selected site, and grey arrows represent all other sites included in this analyses. ",
                                   ),
                               # arrows
                               column(12,
                                      fixedRow(column(12, align = "center",
